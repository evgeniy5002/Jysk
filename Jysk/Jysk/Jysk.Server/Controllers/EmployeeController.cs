...
public class EmployeeController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<IEnumerable<EmployeeDTO>>> GetAllEmployee([FromQuery] string sort, [FromQuery] int page, [FromQuery] int pageSize)
    {
        IEnumerable<EmployeeDTO> arr = await db.GetAll(sort);
        IEnumerable<EmployeeDTO> items = CreatePage(page, pageSize, arr);
