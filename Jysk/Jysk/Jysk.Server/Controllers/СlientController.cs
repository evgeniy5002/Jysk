...
public class ClientController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<IEnumerable<ClientDTO>>> GetAllClient([FromQuery] string sort, [FromQuery] int page, [FromQuery] int pageSize)
    {
        IEnumerable<ClientDTO> arr = await db.GetAll(sort);
        IEnumerable<ClientDTO> items = CreatePage(page, pageSize, arr);
