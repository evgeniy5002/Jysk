...
function Storage() {
    ...
    const url = "https://localhost:7196/api/Storage";
    let Hold_Id;
    ...
    const GetAll = () => {
        axios.get(url)
            ...
            .catch(error => {
                console.error("Error during Storage axios request", error);
            });
    };
            ...
            <div className="data-window" id="data">
                <div className="data-body">
                    ...
                    <div className="admin-field">
                        ...
                        <input id="address" type="text" value={formData.Address} name="Address" onChange={InputChange}></input>
                    </div>
                    <div className="admin-field">
