...
export default function FilterSidebar({ isOpen, onClose, promotionChecked, onPromotionChange }) {
    ...
    return (
        <div className={`filter-sidebar ${isOpen ? 'open' : ''}`}>
            ...
            <div className='scrollable-container'>
                ...
                <FilterAccordion title="Delivery" isOpen={openAccordions['delivery']} onToggle={() => toggleAccordion('delivery')}>
